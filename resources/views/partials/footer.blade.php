<footer class="bg-[#0054a6] text-gray-100 pt-8 pb-[10px]">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-8">
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="flex-1 space-y-5">
                        <div class="space-y-1 opacity-90">
                            <h4 class="text-white font-bold text-lg">Orion Pharma Ltd.</h4>
                        </div>
                        ...
                        <div class="flex items-start gap-4 opacity-90 hover:opacity-100 transition-opacity group">
                            ...
                            <a href="mailto:orion@orion-group.net" class="text-base hover:text-white transition-all">orion@orion-group.net</a>
                        </div>
                    </div>
            ...
            <div class="lg:col-span-1 lg:pl-8">
                ...
                <ul class="space-y-4">
                    ...
                    <li>
                        <a href="#" class="text-base opacity-90 hover:opacity-100 hover:translate-x-1 transition-all inline-block hover:text-white">
                            {{ $link }}
                        </a>
                    </li>
                    @endforeach
            ...
            <div class="lg:col-span-1">
                ...
                <p class="text-base mb-6 text-gray-200 opacity-90">Stay updated with our latest healthcare innovations.</p>
                <div class="flex flex-wrap gap-4">
                    <a href="https://facebook.com/OrionPharmaLtdbd" target="_blank" class="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white hover:text-[#0054a6] transition-all group shadow-sm hover:shadow-lg">
                        <i class="fa-brands fa-facebook-f text-base"></i>
                    </a>
                    <a href="https://linkedin.com/company/orion-group.bd" target="_blank" class="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white hover:text-[#0054a6] transition-all group shadow-sm hover:shadow-lg">
                        <i class="fa-brands fa-linkedin-in text-base"></i>
                    </a>
                    <a href="https://youtube.com/@orionconglomerate" target="_blank" class="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white hover:text-[#0054a6] transition-all group shadow-sm hover:shadow-lg">
