        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-12 mb-8">
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="flex-1 space-y-5">
                        ...
                        <div class="flex items-start gap-4 opacity-90 hover:opacity-100 transition-opacity group">
                            ...
                            <p class="text-[15px]">+88 02 8870130</p>
                        </div>

                        <div class="flex items-start gap-4 opacity-90 hover:opacity-100 transition-opacity group">
                            <i class="fa-solid fa-envelope text-white text-sm mt-1 w-5 text-center"></i>
                            <a href="mailto:orion@orion-group.net"
                                class="text-[15px] hover:text-white transition-all">orion@orion-group.net</a>
                        </div>
                    </div>

                    <div class="flex-1 rounded-lg overflow-hidden border border-white/10 opacity-90 mt-1">
                        <iframe
            ...
            <div class="lg:col-span-1 lg:pl-8">
                ...
                <ul class="space-y-[11.5px]">
                    @php 
                        $quickLinks = ['Home', 'About Us', 'Products', 'Investors', 'CSR', 'News', 'Contact Us', 'Products'];
                    @endphp
                    @foreach($quickLinks as $link)
                        <li>
                            <a href="#" class="text-[15px] opacity-90 hover:opacity-100 hover:translate-x-1 transition-all inline-block hover:text-white">
                                {{ $link }}
                            </a>
                        </li>
                    @endforeach
            ...
            <div class="lg:col-span-1">
                <h1 class="border-b-2 border-white/30 pb-4">
                    Follow Us
                </h1>
                                
                <p class="text-[15px] mb-6 text-gray-200 opacity-90">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="https://linkedin.com/company/orionpharmaltd" target="_blank" class="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white hover:text-orion-blue transition-all group shadow-sm hover:shadow-lg">
                    ...
                    <a href="https://youtube.com/@orionconglomerate" target="_blank" class="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white hover:text-orion-blue transition-all group shadow-sm hover:shadow-lg">
                        <i class="fa-brands fa-youtube text-[15px]"></i>
                    </a>
                </div>
            </div>
        </div>
