    ...
    <aside class="w-70 bg-admin-blue text-white flex flex-col shrink-0 z-20">
        ...
        <nav class=" sidebar-nav flex-1 overflow-y-auto space-y-1 py-4 custom-scrollbar">
            ...
            <a href="{{ route('admin.career.index') }}"
                class="flex items-center gap-3 px-4 py-3 transition-all {{ request()->is('admin/career*') ? 'bg-white/10 text-accent border-l-4 border-accent' : 'text-slate-300 hover:bg-white/5 hover:text-white border-l-4 border-transparent' }}">
