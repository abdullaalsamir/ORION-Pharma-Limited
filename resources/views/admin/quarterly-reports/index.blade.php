...
@section('content')
    <div class="card" style="height: calc(100vh - 100px);">
        <div class="card-header" style="display:flex; justify-content: space-between; align-items: center;">
            <div>
                <h3 style="margin:0">Quarterly Reports</h3>
                <small style="color:#666">Manage and organize Quarterly Reports documents (Sorted by Date)</small>
            </div>
                    ...
                    <div class="menu-card" data-id="{{ $item->id }}" style="margin-bottom:8px;">
                        ...
                        <div style="display:flex; align-items:center; gap:15px; flex-shrink: 0;">
                            ...
                            <div class="menu-actions">
                                ...
                                <form action="{{ route('admin.quarterly-reports.delete', $item) }}" method="POST"
    ...
    <div id="addModal" class="modal-overlay">
        <div class="modal-content" style="width: 550px;">
            ...
            <h3>Add Quarterly Report</h3>
            <form action="{{ route('admin.quarterly-reports.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    @push('scripts')
        <script>
            ...
            document.getElementById('editForm').onsubmit = function (e) {
                ...
                fetch(`/admin/quarterly-reports-actions/${currentEditId}`, {
