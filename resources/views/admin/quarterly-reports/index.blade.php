...
@section('title', 'Quarterly Reports Management')@section('content')
    <div class="admin-card">
        <div class="admin-card-header">
            <div class="flex flex-col">
                <h1>Quarterly Reports</h1>
                <p class="text-xs text-slate-400">Manage and organize Quarterly Reports documents</p>
            </div>
            ...
            <div class="space-y-4">
                ...
                @empty
                    <div
                        ...
                        <h2 class="text-slate-400!">No Quarterly Reports Found</h2>
                    </div>
                @endforelse
            </div>
        </div>
    ...
    <div id="addModal" class="modal-overlay hidden">
        <div class="modal-content max-w-xl! flex flex-col">
            <div class="flex justify-between items-center mb-6 pb-3 border-b border-slate-100 shrink-0">
                <h1 class="mb-0!">Add Quarterly Report</h1>
