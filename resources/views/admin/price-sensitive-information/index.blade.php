...
@section('title', 'Price Sensitive Information Management')@section('content')
    <div class="admin-card">
        <div class="admin-card-header">
            <div class="flex flex-col">
                <h1>Price Sensitive Information</h1>
                <p class="text-xs text-slate-400">Manage and organize Price Sensitive Information documents</p>
            </div>
            ...
            <div class="space-y-4">
                ...
                @empty
                    <div
                        ...
                        <h2 class="text-slate-400!">No Price Sensitive Information Found</h2>
                    </div>
                @endforelse
            </div>
        </div>
    ...
    <div id="addModal" class="modal-overlay hidden">
        <div class="modal-content max-w-xl! flex flex-col">
            <div class="flex justify-between items-center mb-6 pb-3 border-b border-slate-100 shrink-0">
                <h1 class="mb-0!">Add Price Sensitive Information</h1>
                <button type="button" onclick="closeModal('addModal')" class="btn-icon"><i
                        class="fas fa-times text-xl"></i></button>
            </div>

            <form action="{{ route('admin.price-sensitive-information.store') }}" method="POST"
                enctype="multipart/form-data" class="flex-1 overflow-y-auto custom-scrollbar pr-2 space-y-6">
                @csrf
