...
@section('content')
    ...
    @empty
        <div class="p-24 text-center">
            ...
            <h3 class="text-base font-bold text-slate-500 mb-2 uppercase tracking-wide">No Journals Found</h3>
            <p class="text-slate-400 font-medium">There Are Currently No Journals Available For Viewing.</p>
        </div>
    @endforelse
@endsection